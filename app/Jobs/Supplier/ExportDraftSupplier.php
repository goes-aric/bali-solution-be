...
class ExportDraftSupplier extends BaseServices implements ShouldQueue
{
    ...
    public function exportDraft($props){
        try {
            ...
            /* SET DATA HEADER */
            $sheet->setCellValue('A1', 'NAMA_SUPPLIER');
            $sheet->setCellValue('B1', 'ALAMAT');
            $sheet->setCellValue('C1', 'KOTA');
            $sheet->setCellValue('D1', 'KODE_POS');

            /* APPLY STYLE ARRAY */
            $sheet->getStyle('A1:D1')->applyFromArray($styleHeaderArray);
            $sheet->getStyle('A1:D2')->applyFromArray($styleBorderArray);
