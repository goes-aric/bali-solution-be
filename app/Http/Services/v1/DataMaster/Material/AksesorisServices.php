...
use App\Http\Resources\v1\DataMaster\Material\AksesorisResource;
use App\Models\Aksesoris;

class AksesorisServices extends BaseServices
{
    /* PRIVATE VARIABLE */
    private $model;
    private $moduleName;
    ...
    public function fetchLimit($props){
        try {
            ...
            /* RETRIEVE ALL ROW, CONVERT TO ARRAY AND FORMAT AS RESOURCE */
            $datas = $datas->get();
            $datas = AksesorisResource::collection($datas);
            $material = [
                "total" => $totalData,
    ...
    public function fetchById($id){
        try {
            ...
            if ($material) {
                $material = AksesorisResource::make($material);
                return $material;
            }
    ...
    public function createMaterial($props){
        try {
            ...
            $logParameters = [
                ...
                'event'         => 'created',
                'description'   => 'Membuat aksesoris baru [ '.$material->id.' - '.$material->nama_material.' ]',
            ...
            $logParameters = [
                ...
                'module'        => $this->moduleName,
                'event'         => 'created',
                'description'   => 'Gagal membuat aksesoris [ Pesan: '.$ex->getMessage().' ]',
                'user_id'       => $this->returnAuthUser()->id ?? null,
                'old_values'    => $this->oldValues,
                'new_values'    => $this->newValues
            ];
        ...
        try {
            ...
            if ($material) {
                ...
                $logParameters = [
                    ...
                    'module'        => $this->moduleName,
                    'event'         => 'updated',
                    'description'   => 'Memperbaharui aksesoris [ '.$material->id.' - '.$material->nama_material.' ]',
                    'user_id'       => $this->returnAuthUser()->id ?? null,
                    'old_values'    => $this->oldValues,
                    'new_values'    => $this->newValues
                ];
            ...
            $logParameters = [
                ...
                'module'        => $this->moduleName,
                'event'         => 'updated',
                'description'   => 'Gagal memperbaharui aksesoris [ Pesan: '.$ex->getMessage().' ]',
                'user_id'       => $this->returnAuthUser()->id ?? null,
                'old_values'    => $this->oldValues,
                'new_values'    => $this->newValues
            ];
        ...
        try {
            ...
            if ($material) {
                ...
                $logParameters = [
                    ...
                    'module'        => $this->moduleName,
                    'event'         => 'deleted',
                    'description'   => 'Menghapus aksesoris [ '.$this->oldValues->id.' - '. $this->oldValues->nama_material.' ]',
                    'user_id'       => $this->returnAuthUser()->id ?? null,
                    'old_values'    => $this->oldValues,
                    'new_values'    => $this->newValues
                ];
            ...
            $logParameters = [
                ...
                'module'        => $this->moduleName,
                'event'         => 'deleted',
                'description'   => 'Gagal menghapus aksesoris [ Pesan: '.$ex->getMessage().' ]',
                'user_id'       => $this->returnAuthUser()->id ?? null,
                'old_values'    => $this->oldValues,
                'new_values'    => $this->newValues
            ];
        ...
        try {
            ...
            if ($material->count() > 0) {
                ...
                $logParameters = [
                    ...
                    'module'        => $this->moduleName,
                    'event'         => 'deleted',
                    'description'   => 'Menghapus aksesoris [ '.$this->oldValues.' ]',
                    'user_id'       => $this->returnAuthUser()->id ?? null,
                    'old_values'    => $this->oldValues,
                    'new_values'    => $this->newValues
                ];
