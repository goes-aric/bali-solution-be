...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('paket_produk_kaca', function (Blueprint $table) {
            $table->id();
            ...
            $table->foreign('material_id')->references('id')->on('kaca')->onDelete('cascade');
    ...
    {
        Schema::dropIfExists('paket_produk_kaca');
    }
};
